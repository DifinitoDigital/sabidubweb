...
// Calculate target date: 3 months and 2 weeks from now
const now = new Date();
...
export default function CountdownPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden font-sans">
      ...
      <div className="fixed bottom-6 right-8 flex space-x-6 z-20">
      ...
      <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-20 text-xs sm:text-sm md:text-base tracking-[1em] text-white/60 font-regular uppercase">
        POWERED BY DIFINITO
      </div>
      {/* Confirmation Dialog */}
      {showDialog && (
