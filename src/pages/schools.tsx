        ...
        <>
            ...
            <main className="min-h-screen bg-white selection:bg-[#014751] selection:text-white">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20 lg:mb-28">
                            <motion.div initial="initial" animate="animate" variants={fadeInUp} className="flex-1">
                                <span className="text-gray-400 font-bold text-sm tracking-widest mb-6 block uppercase">/ The Gold Standard in Management</span>
                            ...
                            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="lg:max-w-sm">
                                ...
                                <div className="flex items-center gap-6">
                                    <Link href="https://portal.sabidub.com/auth/school/signin" className="text-orange-600 font-black text-[11px] uppercase tracking-widest flex items-center gap-1 group">
                                    ...
                                    <Link href="#" className="text-orange-600 font-black text-[11px] uppercase tracking-widest flex items-center gap-1 group">
                ...
                <section className="py-32 bg-[#FAF9F6] relative overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-24 max-w-3xl mx-auto">
                            <h2 className="text-4xl sm:text-6xl font-black text-gray-900 tracking-tighter mb-8 leading-none">Built for Precision, Scaling with <span className="text-orange-600">Ease.</span></h2>
                            <p className="text-gray-500 font-medium text-lg leading-relaxed">Advanced institutional infrastructure designed to bridge the educational gap in Nigeria.</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 auto-rows-[300px]">
                            {/* Card 1: Student Tracking (Large) */}
                            <motion.div whileHover={{ y: -10 }} className="md:col-span-8 md:row-span-2 bg-white rounded-[48px] p-12 flex flex-col justify-between border border-gray-100 group shadow-sm hover:shadow-xl transition-all relative overflow-hidden">
                                <div className="absolute top-0 right-0 w-64 h-64 bg-orange-500/5 rounded-full -translate-y-1/2 translate-x-1/2" />
                                <div className="relative z-10">
                                    <div className="w-16 h-16 bg-orange-500 text-white rounded-2xl flex items-center justify-center mb-10 shadow-lg shadow-orange-500/20">
                                    ...
                                    <h3 className="text-4xl font-black text-gray-900 mb-6 tracking-tight">Intelligent Student Tracking</h3>
                            ...
                            {/* Card 2: Records (Tall) */}
                            <motion.div whileHover={{ y: -10 }} className="md:col-span-4 md:row-span-2 bg-[#014751] rounded-[48px] p-12 flex flex-col justify-between group overflow-hidden relative border border-gray-800">
                                ...
                                <div className="relative z-10">
                                    <div className="w-16 h-16 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center mb-10">
                                    ...
                                    <h3 className="text-3xl font-black text-white mb-6 tracking-tight">Secure Infrastructure</h3>
                                    <p className="text-white/60 text-lg leading-relaxed font-medium">
                                        A high-security repository for academic calendars and verified student records.
                                    </p>
                                </div>
                                <div className="w-full aspect-square bg-white/5 rounded-[32px] border border-white/10 flex items-center justify-center">
                                    <div className="w-20 h-20 border-4 border-[#AFF8C8]/20 rounded-full flex items-center justify-center">
                                        <div className="w-12 h-12 bg-[#AFF8C8] rounded-full scale-100 group-hover:scale-125 transition-transform" />
                                    </div>
                                </div>
                            </motion.div>

                            {/* Card 3: Admission (Wide) */}
                            <motion.div whileHover={{ y: -10 }} className="md:col-span-12 bg-orange-500 rounded-[48px] p-12 flex flex-col md:flex-row items-center gap-12 group overflow-hidden relative border border-orange-400">
                                <div className="flex-1 relative z-10 text-white">
                                    <h3 className="text-4xl font-black mb-6 tracking-tight leading-none">Admission Analysis Hub</h3>
                                ...
                                <div className="flex-1 flex gap-4 relative z-10 w-full md:w-auto h-32 md:h-full">
                                    <div className="flex-1 bg-white/20 backdrop-blur-md rounded-3xl border border-white/30 flex flex-col p-6 items-center justify-center">
                                    ...
                                    <div className="flex-1 bg-white/90 rounded-3xl border border-white shadow-xl flex flex-col p-6 items-center justify-center">
                ...
                <section className="py-24 bg-white">
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#014751] rounded-[48px] p-12 sm:p-20 relative overflow-hidden text-center">
                        ...
                        <h2 className="text-4xl sm:text-5xl font-black text-white mb-8 relative z-10">Empower your institution today.</h2>
                        ...
                        <Link href="https://portal.sabidub.com/auth/school/signin" className="inline-block px-12 py-5 bg-[#D7FF40] text-black rounded-2xl font-black text-lg transition-transform hover:scale-105 active:scale-95 relative z-10">
