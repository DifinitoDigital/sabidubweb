        ...
        <section className="px-4 sm:px-6 py-12 sm:py-20 max-w-7xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">We collect the following types of information to provide and improve our Services:</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">We do not sell your personal information. We may share information in the following cases:</p>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
            ...
            <div>
              ...
              <p className="text-gray-600">SabiDub targets secondary (ages 11-18) and tertiary (ages 18-25+) students. For users under 18, we require parental or guardian consent to collect personal information. Schools using institutional plans must ensure compliance with local child protection laws.</p>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">International Data Transfers</h2>
              <p className="text-gray-600">As SabiDub expands across Africa (e.g., Kenya, Ghana), data may be transferred to servers outside Nigeria. We ensure compliance with data protection laws in all operating regions, including Nigeria's Data Protection Regulation (NDPR).</p>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Third-Party Links</h2>
              <p className="text-gray-600">Our Services may include links to third-party websites (e.g., partner institutions, telecoms). We are not responsible for their privacy practices and encourage you to review their policies.</p>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Changes to This Policy</h2>
              <p className="text-gray-600">We may update this Privacy Policy to reflect changes in our Services or legal requirements. We will notify users via email or platform announcements at least 30 days before significant changes take effect.</p>
            </div>
