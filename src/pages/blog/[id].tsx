    ...
    return (
      <main className="min-h-screen bg-[#111] flex items-center justify-center px-4">
        <div className="text-center text-white">
          <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-[#FFEDB1] mb-4"></div>
          <p>Loading post...</p>
        </div>
      </main>
    );
    ...
    return (
      <main className="min-h-screen bg-[#111] flex items-center justify-center px-4">
        <div className="text-center text-white">
          ...
          <Link href="/blog" className="text-[#FFEDB1] hover:underline">
            ← Back to Blog
          </Link>
        </div>
      </main>
      ...
      <motion.main initial="initial" animate="animate" className="min-h-screen bg-[#111] relative overflow-x-hidden">
        ...
        <section className="relative w-full h-96 sm:h-[500px] mb-12 flex items-end">
          ...
          <div className="relative z-10 p-8 max-w-5xl mx-auto w-full">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="inline-block bg-[#FFEDB1]/20 backdrop-blur-sm text-[#FFEDB1] px-4 py-2 rounded-full text-sm uppercase tracking-wider font-semibold mb-4">{post.category}</motion.div>
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">{post.title}</motion.h1>
            <div className="flex flex-wrap items-center gap-6 text-sm text-gray-300 mb-4">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-[#FFEDB1]/20 flex items-center justify-center">
                  <span className="text-[#FFEDB1] font-semibold text-sm">{post.author.name.charAt(0)}</span>
                </div>
            ...
            <div className="flex gap-3 mt-6">
              {post.tags.map((tag) => (
                <span key={tag} className="bg-[#FFEDB1]/10 text-[#FFEDB1] px-4 py-2 rounded-full text-sm font-medium border border-[#FFEDB1]/20">{tag}</span>
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="px-4 sm:px-6 py-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-12">
                <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight">{post.title}</h2>
                <p className="text-gray-300 text-xl leading-relaxed mb-6 max-w-3xl font-light">{post.excerpt}</p>
                <div className="w-20 h-1 bg-[#FFEDB1] rounded-full"></div>
              </div>
              ...
              <div className="flex justify-between items-center mt-12 mb-12 pt-6 border-t border-gray-800">
                <button onClick={() => router.push('/blog')} className="flex items-center gap-2 text-[#FFEDB1] hover:text-white transition-colors font-medium">
            ...
            <aside className="lg:col-span-1 space-y-8">
              {/* Author Info */}
              <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-3xl p-8 border border-gray-800/50 shadow-xl text-center">
                <div className="flex flex-col items-center mb-6">
                  <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-[#FFEDB1]/20 mb-4">
                    <Image 
                  ...
                  <div>
                    ...
                    <div className="text-[#FFEDB1] text-sm font-medium">Author</div>
                  </div>
                </div>
                <p className="text-gray-400 text-sm leading-relaxed">SabiDub Team Member</p>
              </div>
              {/* Share This Post */}
              <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-3xl p-8 border border-gray-800/50 shadow-xl">
                <div className="text-white font-bold text-lg mb-6">Share this post</div>
                <div className="flex gap-4">
                  ...
                  <a 
                    ...
                    className="w-12 h-12 bg-[#FFEDB1]/10 rounded-full flex items-center justify-center text-gray-400 hover:text-[#1DA1F2] hover:bg-[#1DA1F2]/20 transition-all"
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-[#FFEDB1]/10 rounded-full flex items-center justify-center text-gray-400 hover:text-[#1877F2] hover:bg-[#1877F2]/20 transition-all"
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-[#FFEDB1]/10 rounded-full flex items-center justify-center text-gray-400 hover:text-[#0A66C2] hover:bg-[#0A66C2]/20 transition-all"
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-[#FFEDB1]/10 rounded-full flex items-center justify-center text-gray-400 hover:text-[#25D366] hover:bg-[#25D366]/20 transition-all"
                  ...
                  <button 
                    ...
                    className="w-12 h-12 bg-[#FFEDB1]/10 rounded-full flex items-center justify-center text-gray-400 hover:text-[#FFEDB1] hover:bg-[#FFEDB1]/20 transition-all"
              ...
              {/* Recent Posts */}
              <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-3xl p-8 border border-gray-800/50 shadow-xl">
                <div className="text-white font-bold text-lg mb-6">Recent Posts</div>
                <ul className="space-y-4">
                  {related.slice(0, 3).map((p) => (
                    <li key={p.id} className="border-b border-gray-800/50 pb-4 last:border-b-0">
                      <Link href={`/blog/${p.slug}`} className="text-[#FFEDB1] hover:text-white transition-colors text-sm font-medium block mb-2">
                        {p.title}
                      </Link>
        ...
        <section className="px-4 sm:px-0 max-w-6xl mx-auto pb-20">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-white mb-4">Related Posts</h3>
            <div className="w-20 h-1 bg-[#FFEDB1] rounded-full mx-auto"></div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {related.map((rel) => (
              <Link href={`/blog/${rel.slug}`} key={rel.id} className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-3xl overflow-hidden shadow-xl hover:scale-[1.02] transition-all duration-300 flex flex-col group border border-gray-800/50">
                <div className="relative w-full h-56">
                  <Image 
                    ...
                    sizes="100vw" 
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#111] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </div>
                <div className="p-8 flex-1 flex flex-col">
                  <div className="inline-block bg-[#FFEDB1]/20 text-[#FFEDB1] px-3 py-1 rounded-full text-xs uppercase tracking-wider font-semibold mb-4 w-fit">{rel.category}</div>
                  <h2 className="text-xl font-bold text-white mb-4 group-hover:text-[#FFEDB1] transition-colors leading-tight">{rel.title}</h2>
                  <p className="text-gray-400 mb-6 flex-1 leading-relaxed">{rel.excerpt}</p>
                  <div className="flex items-center gap-4 text-sm text-gray-400 mb-4">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded-full bg-[#FFEDB1]/20 flex items-center justify-center">
                        <span className="text-[#FFEDB1] font-semibold text-xs">{rel.author.name.charAt(0)}</span>
                      </div>
                  ...
                  <div className="flex gap-2">
                    {rel.tags.map((tag) => (
                      <span key={tag} className="bg-[#FFEDB1]/10 text-[#FFEDB1] px-3 py-1 rounded-full text-xs font-medium border border-[#FFEDB1]/20">{tag}</span>
                    ))}
                  </div>
                </div>
              </Link>
