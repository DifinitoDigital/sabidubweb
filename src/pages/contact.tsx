    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-96 h-96 bg-yellow-400 opacity-5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-yellow-400 opacity-5 rounded-full translate-y-1/2 -translate-x-1/2"></div>
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            >
              Let's Start a
              <span className="text-yellow-600 block">Conversation</span>
            </motion.h1>
            <motion.p
              variants={fadeIn}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <motion.div
                ...
                className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl text-center border border-gray-200 hover:border-yellow-400/30 transition-all duration-300"
              >
                <div className="text-yellow-600 flex justify-center mb-6">
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            >
              {/* Background decoration */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-yellow-400 opacity-5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-4 text-gray-900 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all duration-300 placeholder-gray-400"
                  ...
                  <motion.div variants={fadeInUp}>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-white border border-gray-200 rounded-xl px-4 py-4 text-gray-900 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all duration-300"
                      required
                    >
                  ...
                  <motion.div variants={fadeInUp}>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={6}
                      className="w-full bg-white border border-gray-200 rounded-xl px-4 py-4 text-gray-900 focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all duration-300 placeholder-gray-400 resize-none"
        ...
        >
          <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-r from-white to-gray-50 p-8 sm:p-12 relative overflow-hidden border border-gray-200">
            <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-400 opacity-5 rounded-full translate-x-1/3 -translate-y-1/3"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-yellow-400 opacity-5 rounded-full -translate-x-1/3 translate-y-1/3"></div>
            <div className="relative z-10">
              <motion.h2
                variants={fadeInUp}
              ...
              >
                Download Our App
                <span className="text-yellow-600 block">Start Learning Today!</span>
              </motion.h2>
              <motion.p
                variants={fadeIn}
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-white border border-gray-100 shadow-sm text-gray-900 px-8 py-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 transition-all duration-300 transform border border-gray-200 hover:border-yellow-400/30"
                >
                  <svg
